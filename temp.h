...
#define CONF_REG_MAX_RESOLUTION 0X6000
#define CONF_REG_MAX_S_RESOLUTION 0X4000
#define CONF_REG_MIN_RESOLUTION 0x0000
#define CONF_REG_MIN_S_RESOLTUION 0X0X2000
